...
Статус: **дизайн на будущее**. Git-aware флаги и "prepare-only run" из этого
документа отсутствуют в текущем MVP CLI. Сейчас MVP использует композитный
вызов `sqlrs prepare:psql ... run:psql ...`.
